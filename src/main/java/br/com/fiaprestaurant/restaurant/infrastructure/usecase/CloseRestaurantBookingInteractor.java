...
@Service
public class CloseRestaurantBookingInteractor implements CloseRestaurantBookingUseCase {
  ...
  public CloseRestaurantBookingInteractor(BookingGateway bookingGateway,
      UuidValidator uuidValidator, RestaurantGateway restaurantGateway, UserGateway userGateway,
      @Qualifier(value = "closeRestaurantBookingMailer") RestaurantBookingMailer restaurantBookingMailer) {
