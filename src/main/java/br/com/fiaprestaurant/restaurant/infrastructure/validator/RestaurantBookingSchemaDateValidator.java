...
@Component
public class RestaurantBookingSchemaDateValidator implements RestaurantBookingDateValidor {
    ...
    if (LocalDateTime.now().isAfter(bookingDate)) {
      ...
      throw new ValidatorException(
          new FieldError(this.getClass().getSimpleName(), RESTAURANT_BOOKING_DATE_FIELD,
              RESTAURANT_BOOKING_DATE_MUST_BE_GREATER_THAN_ACTUAL_DATE.formatted(actualDate, bookingDateMessage)));
    }
  }
}
