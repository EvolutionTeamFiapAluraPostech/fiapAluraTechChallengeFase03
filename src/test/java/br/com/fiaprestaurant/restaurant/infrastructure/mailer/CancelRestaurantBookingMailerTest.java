...
class CancelRestaurantBookingMailerTest {
  ...
  @InjectMocks
  private CancelRestaurantBookingMailer cancelRestaurantBookingMailer;

  @Test
  void shouldCancelRestaurantBookingMailer() {
    var user = createUser();
    ...
    assertThatCode(() -> cancelRestaurantBookingMailer.createAndSendEmail(booking, restaurant,
